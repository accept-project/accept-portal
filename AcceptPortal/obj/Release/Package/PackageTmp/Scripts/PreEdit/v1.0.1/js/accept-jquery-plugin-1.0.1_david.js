...
debugger;/*change*/
                            if (header.Type == "GRAMMAR" || header.Type == "SPELLING" ||  (header.Type == "STYLE" && body.Suggestion.length > 0) ) {
        ...
        function DoAcceptRequest(text) {
            ...
            if (text != null && text.length > 0) {
				...
				var jsonData = '{User:"david", Password:"David_Silva@symantec.com", Text:"' + text + '", Language:"' + settings.Lang + '", Rule:" ' + settings.Rule + '", Grammar:"' + checkGrammar + '", Spell:"' + checkSpelling + '", Style:"' + checkStyle + '", RequestFormat:"' + settings.requestFormat + '"}';   
...
ylesIndex], spnid + "_endContext", spnid, 'onmouseover', 'onmouseover');
                                    endPieceFound = true;
                                    skip = 1;
                                }
                                else {
