/********************************************************************************************************************************************/
/*                                                                                                                                          */
/*  ACCEPT Pre-Editing Plug-in 2.0 beta version                                                                                             */
/*                                                                                                                                          */
/*                                                                                                                                          */
/********************************************************************************************************************************************/
...
(function ($) {
    ...
    $.fn.Accept = function (options) {
        ...
        var loadOnTheFlyEditTextEditor = function () {
            $.AcceptTinyMceEditor = tinyMCE.init({ mode: 'exact', elements: 'editArea_' + acceptContainerId + '',
            ...
            if (text != null && text.length > 0) {
                ...
                if ($.browser.msie)
                {
                    ...
                    if (globalSessionId != null && globalSessionId.length > 0)
                        ...
                        //jsonData = '{"UserName":"' + "david" + '","Password":"' + "David_Silva@symantec.com" + '","GlobalSessionId":"' + globalSessionId + '", Text:"' + text + '", Language:"' + settings.Lang + '", Rule:" ' + settings.Rule + '", Grammar:"' + checkGrammar + '", Spell:"' + checkSpelling + '", Style:"' + checkStyle + '", SessionMetadata:"' + buildSessionMetadata() + '", RequestFormat:"' + settings.requestFormat + '"}';
                    else
                        //jsonData = '{"UserName":"' + "david" + '","Password":"' + "David_Silva@symantec.com" + '", "Text":"' + text + '", "Language":"' + settings.Lang + '", "Rule":" ' + settings.Rule + '", "Grammar":"' + checkGrammar + '", "Spell":"' + checkSpelling + '", "Style":"' + checkStyle + '", SessionMetadata:"' + buildSessionMetadata() + '", "RequestFormat":"' + settings.requestFormat + '"}';
        ...
        function CreateAcceptDialog() {
            ...
            $("#" + acceptDialogId + "").dialog({ width: settings.dialogWidth, height: settings.dialogHeight, draggable: settings.isDraggable, modal: settings.isModal, maxWidth: settings.placeHolderMaxWidth, minHeight: settings.placeHolderMinHeight, minWidth: settings.placeHolderMinWidth, resizable: false, title: "",
                maxHeight: settings.placeHolderMaxHeight,
