...
(function ($) {
    ...
    $.fn.AcceptPostEdit = function (options) {
        ...
        var initAcceptPostEdit = function () {
            ...
            $(thisObject).each(function () {
                ...
                $(this).bind('click', function () {
                    debugger;
                    //before the existence of think phases this was responsible to start counting the edition timestamp,
        ...
        var generateDialogWindow = function () {
            ...
            $('#postEditDialog_').dialog({ width: settings.dialogWidth, height: settings.dialogHeight, resizable: true,
...
var go_to_page = function (page_num, paginationContainerId) {
    ...
    if (globalPreviousTranslationUnitIndex != globalCurrentTranslationUnitIndex) {
        ...
        //commentsbug(the second condition protects the comment to be assigned to a think phase that doesnt exists)
