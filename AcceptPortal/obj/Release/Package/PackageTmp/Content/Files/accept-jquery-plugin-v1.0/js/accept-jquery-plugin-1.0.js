    ...
    $.fn.Accept = function (options) {
        ...
        var initAccept = function () {
            ...
            if (settings.configurationType == "tinyMceEmbedded") {
                ...
                if (settings.textEditorPlaceHolderId != null && settings.textEditorPlaceHolderId.length > 0) {
                    setTimeout(function () {
        ...
        function LoadTextEditor() {
            ...
            $('#' + acceptObjectId).tinymce({
                ...
                entity_encoding : "raw",
                plugins: "",
                theme_advanced_buttons3: "btnTinyMceAccept_" + acceptObjectId + "",
                ...
                setup: function (ed) { // actually make the control
                    ed.addButton('btnTinyMceAccept_' + acceptObjectId, {
                        ...
                        'image': settings.imagesPath + '/accept_grey.jpg',    //'image': '../../Content/Simulator/img/accept_grey.jpg', 
                        'onclick': function () {
                            checkGrammar = "1";
                            checkSpelling = "1";
                            checkStyle = "1";
        ...
        function DisplayNoResultsyMessage(context) {
            ...
            //if (acceptGenericResponses.length == 0 && acceptNonSuggestionGenericResponses.length == 0) {
            //$("#btn-replace-accept").css("display", "none");
            $("#" + btnFixAllId).css("display", "none");
            $("#" + acceptDialogId + " .loadmask").css("display", "none");
            $("#" + acceptContainerId).css("display", "block");
            $("#" + acceptContainerId).text(unescape(acceptTextContext)); //$("#divaccept").html(message);
            // }
        ...
        function CreateAcceptDialog() {
            $("#" + acceptDialogId + "").dialog({ width: settings.dialogWidth, height: settings.dialogHeight,
                open: function (event, ui) {
                    ...
                    $(".ui-dialog-titlebar").append('<img id="' + imgDialogTitleId + '" style="margin-top:5px;margin-right:15px" src="' + settings.imagesPath + '/accept_dialog_title.png" alt="Accept" />');
                },
